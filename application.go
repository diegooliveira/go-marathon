...
// SetIPAddressPerTask defines that the application will have a IP address defines by a external agent. this
// configuration is not allowed to be used with Port or PortDefinitions.
...
// EmptyIPAddressPerTask explicitly empties port definitions -- use this if you need to empty
// IP address per task of an application that already has some definitions set (setting port definitions to nil will
// keep the current value)
func (r *Application) EmptyIPAddressPerTask() *Application {
	r.IPAddressPerTask = nil
...
// EmptyDiscovery explicitly empties discovey data -- use this if you need to empty
// discovey of an application that already has ip per task with discovey defined
func (i *IPAddressPerTask) EmptyDiscovery() *IPAddressPerTask {
	i.Discovery = nil
	return i
}
